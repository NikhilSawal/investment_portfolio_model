...
# Save Model
regressor.save('/Users/nikhilsawal/OneDrive/investment_portfolio/models/n_uni_lstm')

model = keras.models.load_model('/Users/nikhilsawal/OneDrive/investment_portfolio/models/n_uni_lstm')
...
real_stock_price = psql.read_sql("""
                                    ...
                                    where date::date = '2021-04-16' and
